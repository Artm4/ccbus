/* AngularParser.java */
/* Generated By:JJTree&JavaCC: Do not edit this line. AngularParser.java */
 ...
 */
public class AngularParser/*@bgen(jjtree)*/implements AngularParserTreeConstants, AngularParserConstants {/*@bgen(jjtree)*/
  protected JJTAngularParserState jjtree = new JJTAngularParserState();public JJTAngularParserState getTree()
    {
        return jjtree;
    }
...
if (jjtc000) {
  ...
  final public void ClassOrInterfaceBodyDeclaration(boolean isInterface) throws ParseException {/*@bgen(jjtree) ClassOrInterfaceBody */
...
if (jjtc000) {
  ...
  private boolean jj_3R_128()
 {
  ...
  public AngularParserTokenManager token_source;
  ...
  public AngularParser(java.io.InputStream stream) {
     this(stream, null);
  }
  /** Constructor with InputStream and supplied encoding */
  public AngularParser(java.io.InputStream stream, String encoding) {
    try { jj_input_stream = new JavaCharStream(stream, encoding, 1, 1); } catch(java.io.UnsupportedEncodingException e) { throw new RuntimeException(e); }
    token_source = new AngularParserTokenManager(jj_input_stream);
    token = new Token();
    jj_ntk = -1;
  }
  ...
  /** Constructor. */
  public AngularParser(java.io.Reader stream) {
  ...
  public AngularParser(AngularParserTokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
  }
  ...
  /** Reinitialise. */
  public void ReInit(AngularParserTokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jjtree.reset();
