...
/* Generated By:JavaCC: Do not edit this line. QueryTokenManager.java */
...
/** Token Manager. */
@SuppressWarnings("unused")public class QueryTokenManager implements QueryConstants {
...
"", null, null, null, null, null, null, null, "\73", "\56", "\54", null, null, 
null, };
...
private void jjCheckNAddTwoStates(int state1, int state2)
{
   ...
   jjCheckNAdd(state2);
    ...
    /** Constructor. */
    public QueryTokenManager(SimpleCharStream stream){
  ...
  /** Constructor. */
  public QueryTokenManager (SimpleCharStream stream, int lexState){
    ReInit(stream);
    SwitchTo(lexState);
  }
